...
def plot_boxplot(country: str) -> None:
    ...
    plt.savefig(f'../results/{country}_boxplot.pdf')
...
def plot_full_beeswarm_with_random(country: str) -> None:
    ...
    for target in ['drift', 'diffusion']:
        # get shap values
        path_prefix = f'../results/ml_v3_random_noise/explainers/{country}_detrended_{target}'
        with open(f'{path_prefix}_gbt_lgb_shap_values', 'rb') as file:
        ...
        fig.set_figwidth(10)
        plt.tight_layout()
        plt.savefig(f'../results/ml_v3_random_noise/plots/shap/full/{country}_gbt_lgb_full_{target}_beeswarm.png')
        plt.savefig(f'../results/ml_v3_random_noise/plots/shap/full/{country}_gbt_lgb_full_{target}_beeswarm.pdf')
        ...
        fig.set_figwidth(10)
        plt.tight_layout()
        plt.savefig(f'../results/ml_v3_random_noise/plots/shap/full/{country}_gbt_xgb_se_full_{target}_beeswarm.png')
        plt.savefig(f'../results/ml_v3_random_noise/plots/shap/full/{country}_gbt_xgb_se_full_{target}_beeswarm.pdf')
        ...
        fig.set_figwidth(10)
        plt.tight_layout()
        plt.savefig(f'../results/ml_v3_random_noise/plots/shap/full/{country}_gbt_xgb_ae_full_{target}_beeswarm.png')
        plt.savefig(f'../results/ml_v3_random_noise/plots/shap/full/{country}_gbt_xgb_ae_full_{target}_beeswarm.pdf')
        ...
        fig.set_figwidth(10)
        plt.tight_layout()
        plt.savefig(f'../results/ml_v3_random_noise/plots/shap/full/{country}_rf_lgb_full_{target}_beeswarm.png')
        plt.savefig(f'../results/ml_v3_random_noise/plots/shap/full/{country}_rf_lgb_full_{target}_beeswarm.pdf')
